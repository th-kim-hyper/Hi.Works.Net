...
namespace BrityWorks.AddIn.Hi.Works.Activities
{
    public class CaptchaChrome : IActivityItem
    {
        ...
        public virtual object OnRun(IDictionary<string, object> properties)
        {
            ...
            try
            {
                var browser = properties[ChromeBrowserPropKey] as ChromeBrowserObject;
                if (browser != null) {
                    result = "browser is not null";
                }
                
                //var page = browser.Page as PuppeteerSharp.Page;
                //var element = page.QuerySelectorAsync("#mf_ssgoTopMainTab_contents_content1_body_img_captcha").Result;
                //var imgBase64 = element.ScreenshotBase64Async().Result;
                //result = imgBase64;
